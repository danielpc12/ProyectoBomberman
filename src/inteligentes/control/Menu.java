...
public class Menu {
    ...
    public static void createMenu(Group root) {
        ...
        statusGame.setOnMouseClicked(event -> {
            if (BombermanGame.player.isLife()) {
                BombermanGame.running = !BombermanGame.running;
            } else {
    ...
    public static void updateMenu() {
        level.setText("Level: " + BombermanGame._level);

        if (BombermanGame.player.isLife())
            if (BombermanGame.running) {
